...
namespace Crow.Library.DatabaseLayer
{
    ...
    public class Database : IDisposable
    {
            ...
            return rxParams.Replace(_sql, m =>
            {
                ...
                else
                {
                    ...
                    foreach (var o in args_src)
                    {
                        ...
                        else if (o is IDynamicMetaObjectProvider)
                        {
                            dynamic @object = o;
                            arg_val = @object[param];
                            found = true;
                            break;
                        }
                    }
        ...
        {
            return QueryGeneric<T>(sql, args).ToList();
        }
        ...
        public IEnumerable<T> QueryGeneric<T>(string sql, params object[] args)
        {
            if (EnableAutoSelect)
                sql = AddSelectClause<T>(sql);
        ...
        {
            return QueryGeneric<T>(sql.SQL, sql.Arguments);
        }
        ...
        {
            return QueryGeneric<T>(sql, args).Single();
        }
        public T SingleOrDefault<T>(string sql, params object[] args)
        {
            return QueryGeneric<T>(sql, args).SingleOrDefault();
        }
        public T First<T>(string sql, params object[] args)
        {
            return QueryGeneric<T>(sql, args).First();
        }
        public T FirstOrDefault<T>(string sql, params object[] args)
        {
            return QueryGeneric<T>(sql, args).FirstOrDefault();
        }
